...
import com.example.todo.controller.api.todo.model.http.Error
import com.example.todo.controller.api.todo.model.http.ErrorResponse
...
class TodoApiControllerAdvice {
    ...
    fun methodArgumentNotCalidException(e: MethodArgumentNotValidException,
